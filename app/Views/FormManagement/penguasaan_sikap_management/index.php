...
<script>
    $(document).ready(function() {
        let tabel = $('#list-PPM').DataTable({
            processing: true,
            serverSide: true,
            ajax: `${base_url}/form-management/penguasaan-sikap-management/get-all-penguasaan-sikap`,
            order: [],
            columns: [{
                    title: 'No.',
                    data: 'number',
    ...
    $(document).on('click', '#edit-data', function(e) {
        ...
        // get data
        $.ajax({
            url: `${base_url}/form-management/penguasaan-sikap-management/get-penguasaan-sikap`,
            type: 'post',
            data: {
                id: id
            },
            ...
            success: function(data) {
                $('#edit_prodi').val(data.penguasaan_sikap.prodi_id);
                $('#penguasaan_sikap_id').val(data.penguasaan_sikap.id);

                let divDetailData = $('#edit-detail-data');
                divDetailData.html('');

                data.detail_penguasaan_sikap.forEach((value, index) => {
                    if (index == 0) {
                        ...
                        <div class="row">
                            <div class="col">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" id="detail_data" name="penguasaan_sikap[]" rows="3">${value.isi_penguasaan_sikap}</textarea>
                                </div>
                            </div>
                            <div class="col">
                                <div class="form-group">
                                    <label for="detail_data_en">Isi text (inggris)</label>
                                    <textarea class="form-control" id="detail_data" name="penguasaan_sikap_en[]" rows="3">${value.isi_penguasaan_sikap_en}</textarea>
                                </div>
                            </div>
                            <div class="col">
                            </div>
    ...
    $(document).on('click', '#delete-data', function(e) {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                // delete
                $.ajax({
                    url: `${base_url}/form-management/penguasaan-sikap-management/delete-penguasaan-sikap`,
                    type: 'post',
                    data: {
                        id: id
                            // setup csrf token
        ...
        let detailData = `
            <div class="row">
                <div class="col">
                    <div class="form-group">
                        <label for="detail_data">Isi text</label>
                        <textarea class="form-control" id="detail_data" name="penguasaan_sikap[]" rows="3"></textarea>
                    </div>
                </div>
                <div class="col">
                    <div class="form-group">
                        <label for="detail_data_en">Isi text (inggris)</label>
                        <textarea class="form-control" id="detail_data" name="penguasaan_sikap_en[]" rows="3"></textarea>
                    </div>
                </div>
                <div class="col">
                    <button type="button" class="btn btn-danger mt-4" id="remove-detail-data"><i class="fas fa-trash"></i></button>
...
<div class="modal fade" id="modalAddData" tabindex="-1" aria-labelledby="modalAddDataLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <form action="<?= base_url('form-management/penguasaan-sikap-management/add-penguasaan-sikap') ?>" method="post">
                <?= csrf_field() ?>
...
<div class="modal fade" id="modalEditData" tabindex="-1" aria-labelledby="modalEditDataLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <form action="<?= base_url('form-management/penguasaan-sikap-management/update-penguasaan-sikap') ?>" method="post">
                <?= csrf_field() ?>
                <input type="hidden" name="penguasaan_sikap_id" id="penguasaan_sikap_id">
                <div class="modal-body">
                    <div class="form-group">
                        <label for="prodi">Pilih Prodi</label>
