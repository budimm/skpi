...
<script>
    $(document).ready(function() {
        let tabel = $('#list-PPM').DataTable({
            processing: true,
            serverSide: true,
            ajax: `${base_url}/form-management/kemampuan-bidang-umum-management/get-all-kemampuan-bidang-umum`,
            order: [],
            columns: [{
                    title: 'No.',
                    data: 'number',
    ...
    $(document).on('click', '#edit-data', function(e) {
        ...
        // get data
        $.ajax({
            url: `${base_url}/form-management/kemampuan-bidang-umum-management/get-kemampuan-bidang-umum`,
            type: 'post',
            data: {
                id: id
            },
            ...
            success: function(data) {
                $('#edit_prodi').val(data.kemampuan_bidang_umum.prodi_id);
                $('#kemampuan_bidang_umum_id').val(data.kemampuan_bidang_umum.id);

                let divDetailData = $('#edit-detail-data');
                divDetailData.html('');

                data.detail_kemampuan_bidang_umum.forEach((value, index) => {
                    if (index == 0) {
                        ...
                        <div class="row">
                            <div class="col">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" id="detail_data" name="kemampuan_bidang_umum[]" rows="3">${value.isi_kemampuan_bidang_umum}</textarea>
                                </div>
                            </div>
                            <div class="col">
                                <div class="form-group">
                                    <label for="detail_data_en">Isi text (inggris)</label>
                                    <textarea class="form-control" id="detail_data" name="kemampuan_bidang_umum_en[]" rows="3">${value.isi_kemampuan_bidang_umum_en}</textarea>
                                </div>
                            </div>
                            <div class="col">
                            </div>
    ...
    $(document).on('click', '#delete-data', function(e) {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                // delete
                $.ajax({
                    url: `${base_url}/form-management/kemampuan-bidang-umum-management/delete-kemampuan-bidang-umum`,
                    type: 'post',
                    data: {
                        id: id
                            // setup csrf token
        ...
        let detailData = `
            <div class="row">
                <div class="col">
                    <div class="form-group">
                        <label for="detail_data">Isi text</label>
                        <textarea class="form-control" id="detail_data" name="kemampuan_bidang_umum[]" rows="3"></textarea>
                    </div>
                </div>
                <div class="col">
                    <div class="form-group">
                        <label for="detail_data_en">Isi text (inggris)</label>
                        <textarea class="form-control" id="detail_data" name="kemampuan_bidang_umum_en[]" rows="3"></textarea>
                    </div>
                </div>
                <div class="col">
                    <button type="button" class="btn btn-danger mt-4" id="remove-detail-data"><i class="fas fa-trash"></i></button>
            ...
            <div class="col">
                <div class="card card-primary card-outline">
                    <div class="card-header">
                        <h5 class="m-0">Tabel Kemampuan Bidang Umum</h5>
...
<div class="modal fade" id="modalAddData" tabindex="-1" aria-labelledby="modalAddDataLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <form action="<?= base_url('form-management/kemampuan-bidang-umum-management/add-kemampuan-bidang-umum') ?>" method="post">
                <?= csrf_field() ?>
...
<div class="modal fade" id="modalEditData" tabindex="-1" aria-labelledby="modalEditDataLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <form action="<?= base_url('form-management/kemampuan-bidang-umum-management/update-kemampuan-bidang-umum') ?>" method="post">
                <?= csrf_field() ?>
                <input type="hidden" name="kemampuan_bidang_umum_id" id="kemampuan_bidang_umum_id">
                <div class="modal-body">
                    <div class="form-group">
                        <label for="prodi">Pilih Prodi</label>
